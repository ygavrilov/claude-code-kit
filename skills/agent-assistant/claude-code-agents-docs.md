...
| `claude` | Inherit | — | Default delegate for a background session (`claude agents` / `claude --bg`) when no agent is named; can also receive delegation like any other subagent |
